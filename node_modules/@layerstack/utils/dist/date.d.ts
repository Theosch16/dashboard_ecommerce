import { type CountableTimeInterval, type TimeInterval } from 'd3-time';
import { PeriodType, DayOfWeek, type SelectedDate, type CustomIntlDateTimeFormatOptions, type FormatDateOptions, type PeriodTypeCode, type TimeIntervalType } from './date_types.js';
...
export declare function getMonthDaysByWeek(dateInTheMonth: Date, weekStartsOn?: DayOfWeek, options?: {
    utc?: boolean;
}): Date[][];
...
export declare function isSameFiscalYear(dateLeft: Date, dateRight: Date, options?: Parameters<typeof getFiscalYear>[1]): boolean;
export declare function startOfBiWeek(date: Date, week: number, startOfWeek: DayOfWeek, options?: {
    utc?: boolean;
}): Date;
export declare function endOfBiWeek(date: Date, week: number, startOfWeek: DayOfWeek, options?: {
    utc?: boolean;
}): Date;
/**
 ...
 */
export declare function getDateFuncsByPeriodType(settings: LocaleSettings, periodType: PeriodType | null | undefined, options?: {
    utc?: boolean;
}): {
 ...
 */
export declare function formatIntl(settings: LocaleSettings, dt: Date, tokens_or_intlOptions: CustomIntlDateTimeFormatOptions, options?: {
    utc?: boolean;
}): string;
 ...
 */
export declare const utcQuarter: CountableTimeInterval;
/**
