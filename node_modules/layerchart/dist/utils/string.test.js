...
describe('getTextRect', () => {
    ...
    describe('multiline', () => {
        ...
        it('matches the string form for a single line', () => {
            expect(getTextRect(['abcde'], 0, 0, { fontSize })).toEqual(getTextRect('abcde', 0, 0, { fontSize }));
        });
    });
    describe('rotate', () => {
        it('is a no-op at 0 degrees', () => {
            expect(getTextRect('abcde', 7, 3, { fontSize, rotate: 0 })).toEqual(getTextRect('abcde', 7, 3, { fontSize }));
        });
