...
describe('isScaleUtc', () => {
    ...
    it('is true for scaleUtc', () => {
        expect(isScaleUtc(scaleUtc().domain(domain))).toBe(true);
    });
    it('is false for scaleTime', () => {
        expect(isScaleUtc(scaleTime().domain(domain))).toBe(false);
    });
    it('is false for non-time scales', () => {
        expect(isScaleUtc(scaleLinear().domain([0, 10]))).toBe(false);
        expect(isScaleUtc(scaleBand().domain(['a', 'b']))).toBe(false);
    });
