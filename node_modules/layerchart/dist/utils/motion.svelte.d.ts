 ...
 */
export declare function createPathMotionMap(motionProp: MotionProp | undefined, interpolate: (a: string, b: string) => (t: number) => string): {
    /**
     ...
     */
    update(key: any, d: string, getInitial?: () => string): void;
