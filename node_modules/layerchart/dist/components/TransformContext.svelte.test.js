    ...
    describe('pinch to zoom', () => {
        ...
        async function setup(transform) {
            ...
            const element = await vi.waitFor(() => {
                const el = document.querySelector('.lc-transform-context');
                expect(el).not.toBeNull();
                return el;
            });
            const rect = element.getBoundingClientRect();
            function dispatch(type, pointerId, x, y) {
        ...
        it('should only use the horizontal distance in domain mode with `axis: x`', async () => {
            ...
            const rect = element.getBoundingClientRect();
            const dispatch = (type, pointerId, x, y) => element.dispatchEvent(new PointerEvent(type, {
                pointerId,
                pointerType: 'touch',
                clientX: rect.left + x,
                clientY: rect.top + y,
        ...
        it('should not show the tooltip while pinching', async () => {
            ...
            const { transformEl, tooltipEl } = await vi.waitFor(() => {
                const transformEl = document.querySelector('.lc-transform-context');
                const tooltipEl = document.querySelector('.lc-tooltip-context');
            ...
            const dispatch = (el, type, pointerId, x, y) => el.dispatchEvent(new PointerEvent(type, {
                pointerId,
                pointerType: 'touch',
                clientX: rect.left + x,
                clientY: rect.top + y,
