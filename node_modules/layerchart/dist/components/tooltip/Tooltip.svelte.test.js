 ...
 */
async function waitForTooltip(el, position, assertion) {
    await vi.waitFor(() => {
...
function getTooltipRoot(target = document.body) {
    const roots = target.querySelectorAll('.lc-tooltip-root');
...
describe('Tooltip', () => {
    ...
    describe('contained="container" (default)', () => {
        it('should flip tooltip left when pointer is near the right edge', async () => {
            ...
            await waitForTooltip(tooltipCtx, { clientX: ctxRect.right - 5, clientY: ctxRect.top + ctxRect.height / 2 }, () => {
                const tooltipRoot = getTooltipRoot();
                expect(tooltipRoot).not.toBeNull();
        ...
        it('should flip tooltip right when pointer is near the left edge', async () => {
            ...
            await waitForTooltip(tooltipCtx, { clientX: ctxRect.left + 5, clientY: ctxRect.top + ctxRect.height / 2 }, () => {
                const tooltipRoot = getTooltipRoot();
                expect(tooltipRoot).not.toBeNull();
                const tooltipLeft = parseFloat(tooltipRoot.style.left);
        ...
        it('should flip tooltip up when pointer is near the bottom edge', async () => {
            ...
            await waitForTooltip(tooltipCtx, { clientX: ctxRect.left + ctxRect.width / 2, clientY: ctxRect.bottom - 5 }, () => {
                const tooltipRoot = getTooltipRoot();
                expect(tooltipRoot).not.toBeNull();
        ...
        it('should flip tooltip down when pointer is near the top edge', async () => {
            ...
            await waitForTooltip(tooltipCtx, { clientX: ctxRect.left + ctxRect.width / 2, clientY: ctxRect.top + 5 }, () => {
                const tooltipRoot = getTooltipRoot();
                expect(tooltipRoot).not.toBeNull();
                const tooltipTop = parseFloat(tooltipRoot.style.top);
