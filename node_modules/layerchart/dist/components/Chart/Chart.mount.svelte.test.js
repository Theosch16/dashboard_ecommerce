...
import MountCounter, { mountCounts, resetMountCounts, sizeAtConstruction, } from '../../tests/MountCounter.svelte';
/**
...
describe('Chart child lifecycle', () => {
    ...
    it('builds children against the measured size, not the placeholder', async () => {
        ...
        await expect.poll(() => mountCounts.mount).toBe(1);
        const container = document.querySelector('.lc-root-container');
