...
describe(`AreaChart`, () => {
    ...
    describe('annotations over a stack', () => {
        it('should place a point naming a series on that series\u2019 stacked top', async () => {
            ...
            await vi.waitFor(() => {
                const circles = [...container.querySelectorAll('.lc-annotation-point')].map((el) => Math.round(Number(el.getAttribute('cy'))));
        ...
        it('should leave an annotation naming no series where it was put', async () => {
            ...
            await vi.waitFor(() => {
                const cy = [...container.querySelectorAll('.lc-annotation-point')].map((el) => Math.round(Number(el.getAttribute('cy'))));
