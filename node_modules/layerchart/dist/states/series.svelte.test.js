...
describe('SeriesState isStackTop', () => {
    ...
    const partial = { date: '2024-04', apples: 10, bananas: 20 };
    const stacked = [...wideData, partial];
    function createStacked(seriesData = series, extra = {}) {
    ...
    it('should treat a zero-height segment as absent', () => {
        const zeroTop = { date: '2024-05', apples: 10, bananas: 20, oranges: 0 };
        const state = createStacked(series, { data: [...stacked, zeroTop] });
    ...
    it('should give a diverging stack a top on each side of the baseline', () => {
        ...
        const diverging = { date: '2024-06', apples: 10, bananas: -5, oranges: 20 };
    ...
    it('should align series that carry their own data', () => {
        ...
        const state = createSeriesState(sepSeries, { layout: 'stack', keyBy: 'date' });
        // `bananas` covers 2024-01 but not 2024-02
        expect(state.isStackTop('apples', sepSeries[0].data[0])).toBe(false);
        expect(state.isStackTop('apples', sepSeries[0].data[1])).toBe(true);
    });
...
describe('SeriesState', () => {
    ...
    describe('stacking', () => {
        ...
        it('should report no stack layout when nothing is stacked', () => {
            ...
            const state = createSeriesState(series, null);
            expect(state.stackLayout).toBe(null);
        });
